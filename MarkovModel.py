...
class PatientStateMonitor:
    ...
    def update(self, k, next_state):
        ...
        if next_state is P.HealthStats.DEATH or next_state is P.HealthStats.Non_stroke_death:
    ...
    def get_if_alive(self):
        result = True
        if self._currentState == P.HealthStats.DEATH or self._currentState == P.HealthStats.Non_stroke_death :
            result = False
        return result
...
class PatientCostUtilityMonitor:
    ...
    def update(self, k, current_state, next_state):
        ...
        # if death will occur
        if next_state in [P.HealthStats.DEATH or P.HealthStats.Non_stroke_death]:
